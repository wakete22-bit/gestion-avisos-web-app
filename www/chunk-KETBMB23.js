import{a as j}from"./chunk-Z7B4QQZC.js";import{b as g}from"./chunk-OW3FFWTU.js";import{F as _,I as m,d as S,f as r,k as u,t as f,z as h}from"./chunk-M7VHNEAX.js";var A=(()=>{let c=class c{constructor(s,e){this.supabaseClientService=s,this.dataUpdateService=e,this.presupuestosSubject=new S([]),this.presupuestos$=this.presupuestosSubject.asObservable(),this.supabase=this.supabaseClientService.getClient()}getPresupuestos(s=1,e=10,t,n,o,i){let a=this.supabase.from("presupuestos").select(`
        *,
        aviso:avisos(
          *,
          cliente:clientes(*)
