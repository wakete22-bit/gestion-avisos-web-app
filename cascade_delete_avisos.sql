-- Script para agregar eliminación en cascada a la tabla avisos
-- Este script modifica las restricciones de clave foránea para que cuando se elimine un aviso,
-- se eliminen automáticamente todos los registros relacionados
...
-- 2. Recrear las restricciones con CASCADE DELETE
...
-- 3. Verificar que las restricciones se han aplicado correctamente
SELECT 
    tc.table_name, 
    tc.constraint_name, 
    tc.constraint_type,
